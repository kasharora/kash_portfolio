      ...
      <div className="services-row">
          ...
          <div className="flip-card">
            <div className="flip-card-inner">
              ...
              <div className="flip-card-back services-card-2">
                <p className="services-card-text" id="services-card-text-4"><br/><br/>" Struggling  To find Realiable <br/>Freelancers? Partners With Me For Consistent, High <br/> Design Work-Flexible And <br/>Easy To Start Or Cancel <br/>Anytime. "</p>
              </div>
            </div>
          </div>
        </div>
